...
class ResearchExcelWriter:
    ...
    def create_research_excel(self, output_path: Path) -> str:
        ...
        self._create_section_4_stability(wb, overview_df)
    ...
    # =========================================================================
    # SECTION 4: STABILITÄT (STABILITY & CONTEXT)
    # =========================================================================

    def _create_section_4_stability(self, wb: Workbook, df: pd.DataFrame):
        """Create Section 4: Stabilität (3 sheets)"""
